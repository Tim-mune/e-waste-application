...
const Action = () => {
  return (
    <div className="flex flex-col pt-2">
      ...
      <p className="mt-2 leading-6 text-white text-clip text-center max-w-lg">
      ...
      <Link
        to="/register"
        className="bg-blue-600 text-white p-2 m-2 rounded-lg hover:-translate-y-1 hover:opacity-70 tracking-wider w-1/4 mx-auto mt-2 text-center"
      >
        Get Started
      </Link>
      <div>
